...
print("Starts with D:")
a = [x.name for x in humans if x.name[0] == 'd' or x.name[0] == 'D']
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [x.name for x in humans if x.name[-1] == 'e' or x.name[-1] == 'E']
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
c = [x.name for x in humans if x.name[0] in "cdefgCDEFG"]
print(c)
